<div id="shopify-section-footer" class="shopify-section">
    <link href="{{ asset('site/s/files/1/0080/9035/3717/t/3/assets/section-footer.css') }}"
          rel="stylesheet" type="text/css" media="all"/>
    <link rel="stylesheet"
          href="{{ asset('site/s/files/1/0080/9035/3717/t/3/assets/component-newsletter.css') }}"
          media="print" onload="this.media='all'">
    <link rel="stylesheet"
          href="{{ asset('site/s/files/1/0080/9035/3717/t/3/assets/component-list-menu.css') }}"
          media="print" onload="this.media='all'">
    <link rel="stylesheet"
          href="{{ asset('site/s/files/1/0080/9035/3717/t/3/assets/component-list-payment.css') }}"
          media="print" onload="this.media='all'">
    <link rel="stylesheet"
          href="{{ asset('site/s/files/1/0080/9035/3717/t/3/assets/component-list-social.css') }}"
          media="print" onload="this.media='all'">
    <link rel="stylesheet"
          href="{{ asset('site/s/files/1/0080/9035/3717/t/3/assets/component-rte.css') }}"
          media="print" onload="this.media='all'">
    <link rel="stylesheet"
          href="{{ asset('site/s/files/1/0080/9035/3717/t/3/assets/disclosure.css') }}"
          media="print" onload="this.media='all'">

    <noscript>
        <link href="{{ asset('site/s/files/1/0080/9035/3717/t/3/assets/component-newsletter.css') }}"
              rel="stylesheet" type="text/css" media="all"/>
    </noscript>
    <noscript>
    ...
    <noscript>
        <link href="{{ asset('site/s/files/1/0080/9035/3717/t/3/assets/component-list-payment.css') }}"
              rel="stylesheet" type="text/css" media="all"/>
    </noscript>
    <noscript>
        <link href="{{ asset('site/s/files/1/0080/9035/3717/t/3/assets/component-list-social.css') }}"
              rel="stylesheet" type="text/css" media="all"/>
    </noscript>
    <noscript>
    ...
    <noscript>
        <link href="{{ asset('site/s/files/1/0080/9035/3717/t/3/assets/disclosure.css') }}"
              rel="stylesheet" type="text/css" media="all"/>
    </noscript>
    ...
    <footer class="footer section-footer-padding">
        <div class="footer__content-top page-width">
            <div class="footer__blocks-wrapper grid grid--1-col grid--4-col-tablet ">
                <div class="footer-block grid__item footer-block--menu"><h3 class="footer-block__heading hidden">Quick
                        links</h3>
                    <ul class="footer-block__details-content list-unstyled">
                        @foreach (\App\Entity\Menu::showWithLocation('menu-footer') as $menu)
                            @foreach (\App\Entity\MenuElement::showMenuPageArray($menu->slug) as $id => $menuElement)
                                @if(  $id < count(\App\Entity\MenuElement::showMenuPageArray($menu->slug)) / 2)
                                    <li>
                ...
                <div class="footer-block--newsletter grid__item">
                    <div class="footer-block__newsletter"><h2 class="caption-large text-body">Subscribe to our
                            emails</h2>
                        <form method="post" onsubmit="return subcribeEmailSubmit(this)" id="ContactFooter" accept-charset="UTF-8"
                            ...
                            <div class="newsletter-form__field-wrapper">
                                <div class="field">
                                    ...
                                    <input
                                            ...
                                            type="email"
                                            name="contact[email]"
                                            class="emailSubmit field__input"
                                            value=""
                                            aria-required="true"
                                            autocorrect="off"
                                            autocapitalize="off"
            ...
            <div class="footer__content-bottom-wrapper page-width">
                <div class="footer__column footer__localization isolate">
                    ...
                    <localization-form>
                            ...
                            <input
                                    ...
                                    type="hidden" name="return_to" value="/collections/latest-products">
                            <div class="">
                                <h2 class="caption-large text-body" id="FooterLanguageLabel">Language</h2>
                                <div class="disclosure">
                                    <button type="button" onclick="showLang()";
                                            class="disclosure__button localization-form__select localization-selector link link--text caption-large"
                                            aria-expanded="false" aria-controls="FooterLanguageList"
                                            aria-describedby="FooterLanguageLabel">
                                            {{ \App\Entity\Language::getLang($languageCurrent) }}
                                    ...
                                    <ul id="FooterLanguageList" role="list" class="disclosure__list list-unstyled"
                                        ...
                                        @foreach ($languages as $id => $language)
                                                <li class="disclosure__item" tabindex="-1">
                                                    <a onclick="return changeLanguage(this);" id="{{ $language->acronym }}"  class="link link--text disclosure__link caption-large focus-inset"
                ...
                <div class="footer__column footer__column--info">
                    ...
                    <div class="footer__copyright caption">
                        <small class="copyright__content">© 2022, {{ isset($information['company-name']) ? $information['company-name'] : '' }}</small>
                    </div>
                </div>
            </div>
        </div>
